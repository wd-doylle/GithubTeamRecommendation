...
repo_num = [repo_profiles[numerics].values]*repo_profiles.shape[0]
repo_num = torch.tensor(repo_num,device=cuda0,requires_grad=False)
dis_num = ((repo_num.transpose(0,1)-repo_num)**2).sum(2)
